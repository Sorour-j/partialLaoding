...
public class EolStandaloneExample {
	...
	public static void main(String[] args) throws Exception {
		...
		modelProperties.setProperty(EmfModel.PROPERTY_NAME, "org.amma.dsl.jdt.dom");
		modelProperties.setProperty(EmfModel.PROPERTY_FILE_BASED_METAMODEL_URI,
			modelsRoot.resolve("/Users/sorourjahanbin/git/mainandstaticanalysis/org.eclipse.epsilon.neo4j/model/JDTAST.ecore").toAbsolutePath().toUri().toString()
		);
	//	modelProperties.setProperty(EmfModel.PROPERTY_METAMODEL_URI,"http://www.lowcomote.eu/EnergyProvider");
		...
		modelProperties.setProperty(EmfModel.PROPERTY_MODEL_URI,
			modelsRoot.resolve("/Users/sorourjahanbin/git/mainandstaticanalysis/org.eclipse.epsilon.neo4j/model/Grabats-set4.xmi").toAbsolutePath().toUri().toString()
		);
		
		EolRunConfiguration runConfig = EolRunConfiguration.Builder()
			.withScript(root.resolve("/Users/sorourjahanbin/git/mainandstaticanalysis/org.eclipse.epsilon.neo4j/scripts/grabats.eol"))
