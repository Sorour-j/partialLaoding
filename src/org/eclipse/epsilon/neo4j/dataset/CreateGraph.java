...
//	}
	// end::createReltype[]
	static String db = "target/IMDB-1";
	public static void main(final String[] args) throws IOException {
		CreateGraph hello = new CreateGraph();
		
		String EcoreMetamodel = "model/movies.ecore";
		String XmiModel = "model/imdb-0.1.xmi";
...
//		OGraphBatchInsert batch = new OGraphBatchInsert(db, "neo4j", "password");
